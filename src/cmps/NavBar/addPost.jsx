...
export default function AddPost({ isOpen, setIsOpen }) {
        ...
        <div className="AddPost__Background__Shadow">
          ...
          <div className='AddPost__Container__Vertical'>
            <div className="AddPost__Container__Horizontal">
              <div className="AddPost__Container">
                <div className="AddPost__Container__Header">
                  <div className="AddPost__Container__Header__BackBtn">
                  ...
                  <div className="AddPost__Container__Header__ShareBtn">

                    <button onClick={handleAddNewPost}>Share</button>
  ...
  const handleAddNewPost = () => {
    ...
    imageData.append("image", post.image)
    imageData.append("caption", post.caption)
    imageData.append("location", post.location)
    dispatch(postsService.newPost(imageData)
    ).then(handleCloseModal).catch(err => console.log(err))
