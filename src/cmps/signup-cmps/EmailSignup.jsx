            ...
            <form>
              ...
              <div className="EmailSignup__Input__Container">
                <div className={`EmailSignup__Email__Input ${email ? "input__active" : ''}`}>
                  ...
                  <label ><span > Email</span> <input aria-label="Email" name="email" type="text" onChange={(event) => {
              ...
              <div className="EmailSignup__Input__Container" >
                <div className={`EmailSignup__fullName__Input ${fullname ? "input__active" : ''}`}>
                  <label ><span > Full Name</span> <input aria-label="FullName" name="fullname" type="text" onChange={(event) => {
              ...
              <div className="EmailSignup__Input__Container">
                <div className={`EmailSignup__userName__Input ${username ? "input__active" : ''}`}>
                  <label ><span > Username</span> <input aria-label="Username" name="username" type="text" onChange={(event) => {
              ...
              <div className="EmailSignup__Input__Container">
                <div className={`EmailSignup__passWord__Input ${password ? "input__active" : ''}`}>
                  <label ><span > Password</span> <input aria-label="Password" name="password" type="text" onChange={(event) => {
